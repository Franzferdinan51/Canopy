...
// Code splitting reduces initial bundle size by loading these components only when needed.
...
const PageLoader = () => (
  <div className="flex items-center justify-center h-full text-canopy-600 dark:text-canopy-400">
