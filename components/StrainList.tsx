...
import { Plus, Camera, Loader2, Link as LinkIcon, GitMerge, Sparkles, Bot } from 'lucide-react';
...
export const StrainList: React.FC<StrainListProps> = ({ strains, setStrains, settings, addLog, onTriggerAI }) => {
  ...
  return (
    <div className="p-6 h-full overflow-y-auto bg-gray-50 dark:bg-gray-950 transition-colors">
      ...
      {/*
        Optimization: StrainItem is memoized to prevent re-renders of the entire list
        when the parent form state changes. Handlers are wrapped in useCallback.
      */}
