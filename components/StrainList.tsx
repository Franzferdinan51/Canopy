  ...
  return (
    <div className="p-6 h-full overflow-y-auto bg-gray-50 dark:bg-gray-950 transition-colors">
      ...
      {strains.length === 0 ? (
        <EmptyState
          icon={Sprout}
          title="No Strains in Library"
          description="Add your seed or clone inventory to track lineage, flowering times, and plan your next run."
          actionLabel="Add Strain"
              ...
              <div>
                <div className="flex justify-between items-start mb-2">
                  ...
                  <div className="flex opacity-0 group-hover:opacity-100 focus-within:opacity-100 transition-opacity">
                    <button onClick={() => handleEdit(strain)} className="text-gray-400 hover:text-blue-500 transition-colors mr-2" title="Edit" aria-label="Edit Strain"><Pencil size={16} /></button>
                    <button onClick={() => handleDelete(strain.id)} className="text-gray-400 hover:text-red-500 transition-colors" title="Delete" aria-label="Delete Strain"><Trash2 size={16} /></button>
                  </div>
                </div>
