...
import { Plus, Trash2, Camera, Droplet, Loader2, Pencil, Package, History, DollarSign, Bot, PackageOpen } from 'lucide-react';
    ...
    <div className="p-6 h-full overflow-y-auto bg-gray-50 dark:bg-gray-950 transition-colors">
      ...
      {nutrients.length === 0 ? (
        <EmptyState
          ...
          description="Your nutrient shelf is empty. Add bottles manually or scan them with AI to get started."
          actionLabel="Add First Nutrient"
